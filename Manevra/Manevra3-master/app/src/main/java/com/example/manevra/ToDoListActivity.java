...
import com.example.manevra.Model.TouchHelper;
...
public class ToDoListActivity extends AppCompatActivity implements OnDialogCloseListner {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.recycer1view);
        ...
        mList = new ArrayList<>();
        adapter = new ToDoAdapter(ToDoListActivity.this , mList);
